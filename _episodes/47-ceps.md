...
* **Publikace [Hodnocení zdrojové přiměřenosti ES ČR do roku 2040 – MAF CZ 2022](https://www.ceps.cz/cs/publikace-ke-stazeni)** (_ČEPS_)\\
  Spočnost ČEPS každoročně vypracovává národní hodnocení zdrojové přiměřenosti (MAF CZ), které v několika scénářích zobrazuje možné trajektorie vývoje českého elektroenergetického sektoru.
