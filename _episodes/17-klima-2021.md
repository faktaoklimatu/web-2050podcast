...
{% include transcript-time.html time="00:11" %}
...
{% include transcript-time.html time="03:18" %}
{% include transcript-person.html id="pribyla" %}
...
{% include transcript-time.html time="04:35" %}
{% include transcript-person.html id="pribyla" %}
...
{% include transcript-time.html time="06:24" %}
{% include transcript-person.html id="pribyla" %}
...
{% include transcript-time.html time="09:28" %}
{% include transcript-person.html id="pribyla" %}
...
{% include transcript-time.html time="12:27" %}
{% include transcript-person.html id="holik" %}
...
{% include transcript-time.html time="14:53" %}
{% include transcript-person.html id="holik" %}
...
{% include transcript-time.html time="15:47" %}
{% include transcript-person.html id="pribyla" %}
...
{% include transcript-time.html time="18:37" %}
{% include transcript-person.html id="pribyla" %}
...
{% include transcript-time.html time="21:05" %}
{% include transcript-person.html id="pribyla" %}
...
{% include transcript-time.html time="25:40" %}
{% include transcript-person.html id="pribyla" %}
...
{% include transcript-time.html time="29:05" %}
{% include transcript-person.html id="pribyla" %}
...
{% include transcript-time.html time="32:34" %}
{% include transcript-person.html id="pribyla" %}
