...
{% include transcript-time.html time="01:29" %}
...
{% include transcript-person.html id="robot" %}
...
{% include transcript-time.html time="04:45" %}
{% include transcript-person.html id="holik" %}
...
{% include transcript-person.html id="rovensky" %}
...
{% include transcript-time.html time="08:35" %}
{% include transcript-person.html id="svobodova" %}
...
{% include transcript-person.html id="holik" %}
Pokud tedy chceme postupně přecházet na obnovitelné zdroje a zároveň potřebujeme držet v síti stabilní napětí, potřebujeme nějaké vyrovnávací zdroje. Elektrárny, které můžeme rychle vypnout a zapnout. Tuto funkci dneska dobře plní plynové elektrárny, případně přečerpávací vodní
elektrárny.
...
{% include transcript-time.html time="14:08" %}
{% include transcript-person.html id="svobodova" %}
...
{% include transcript-time.html time="16:33" %}
{% include transcript-person.html id="svobodova" %}
...
{% include transcript-time.html time="18:10" %}
{% include transcript-person.html id="holik" %}
...
{% include transcript-time.html time="22:08" %}
{% include transcript-person.html id="holik" %}
...
{% include transcript-time.html time="23:50" %}
{% include transcript-person.html id="sklenar" %}
...
{% include transcript-time.html time="28:02" %}
{% include transcript-person.html id="svobodova" %}
...
{% include transcript-person.html id="madej" %}
...
{% include transcript-time.html time="34:23" %}
{% include transcript-person.html id="svobodova" %}
...
{% include transcript-time.html time="37:16" %}
{% include transcript-person.html id="holik" %}
...
{% include transcript-time.html time="40:43" %}
{% include transcript-person.html id="svobodova" %}
