...
{% include transcript-time.html time="04:29" %}
...
{% include transcript-time.html time="06:35" %}
...
{% include transcript-person.html id="pribyla" %} 
A tady je právě rozdíl mezi suchem ve smyslu nemáme pitnou vodu pro člověka a suchem ve smyslu máme vyschlou půdu, takže nám neroste obilí, to jsou vlastně různý sucha.
Třetí typ dopadů je na budovy a infrastrukturu. A v úplně klasický příklad takového dopadu je, že když je vlna veder, tak můžou roztát, dá se říct, runwaye na letišti. 
...
{% include transcript-time.html time="10:40" %}
...
{% include transcript-time.html time="13:35" %}
...
{% include transcript-time.html time="19:57" %}
...
{% include transcript-time.html time="25:35" %}
