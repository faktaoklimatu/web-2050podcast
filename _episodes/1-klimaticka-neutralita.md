...
{% include transcript-person.html id="holik" %} Vítejte u podcastu, který nese název 2050.
{% include transcript-person.html id="svobodova" %}
Já jsem Vendula Svobodová.
{% include transcript-person.html id="holik" %} Moje jméno je Petr Holík.
{% include transcript-person.html id="svobodova" %}
Tohle klimatický podcast o budoucnosti, ve které nám nepoteče do bot.
{% include transcript-person.html id="holik" %} Tohle je naše úplně první epizoda podcastu, který vám přináší projekt Fakta o klimatu.
{% include transcript-person.html id="svobodova" %}
...
{% include transcript-person.html id="holik" %} Chceme se bavit o naší budoucnosti s důrazem na to, co uděláme teď.
{% include transcript-person.html id="svobodova" %}
Téma změny klimatu není jednoduché ani černobílé. Některá řešení nám už teď leží pod rukama. Jiná musíme ještě hledat.
{% include transcript-person.html id="holik" %} V tomto podcastu se dozvíte, co už se v tématu změny klimatu děje.
{% include transcript-person.html id="svobodova" %}
Dozvíte se, co by se dít mohlo, a ještě jsme s tím nezačali.
{% include transcript-person.html id="holik" %} Dozvíte se i o tom, kde se zatím nevíme rady. 
{% include transcript-person.html id="svobodova" %}
Hele, Petře, možná bychom teda mohli vysvětlit, proč se jmenuje 2050. 
{% include transcript-person.html id="holik" %} Možná, protože v roce 2050 nám bude přesně 2× tolik, co nám je teď.
{% include transcript-person.html id="svobodova" %}
...
{% include transcript-person.html id="holik" %} Co jsme pro to udělali. 
{% include transcript-person.html id="svobodova" %}
No, ale samozřejmě není ten hlavní důvod, proč se to jmenuje 2050.
{% include transcript-time.html time="01:19" %}
{% include transcript-person.html id="holik" %} Rok 2050 je totiž důležitým rokem pro klima. V rámci Pařížské dohody se totiž státy světa zavázaly zastavit růst globální teploty výrazně pod hranicí 2 stupně, no a k tomu, aby se tohle povedlo, je potřeba do roku 2050 dosáhnout klimatické neutrality.
{% include transcript-person.html id="svobodova" %}
...
{% include transcript-person.html id="holik" %} Tím prvním sektorem je třeba energetika tzn. výroba elektrické energie výroba tepla. To je v České republice hodně velký téma, to je zhruba 40 % emisí skleníkových plynů.
Energetika 40 % emisí skleníkových plynů. 
{% include transcript-person.html id="svobodova" %}
Další téma je zemědělství, tam máme 7 % emisí skleníkových plynů, a taky se pak podíváme na lesnictví a vůbec na celkové nakládání s naší krajinou.
Zemědělství, 7 % emisí skleníkových plynů.
{% include transcript-person.html id="holik" %} Asi už jste slyšeli o tom, jestli máme mít spalovací motory nebo elektroauta, takže další velký téma bude doprava. Doprava u nás dělá zhruba 16 % emisí skleníkových plynů.
Doprava u nás dělá zhruba 16 % emisí skleníkových plynů.
{% include transcript-person.html id="svobodova" %}
Další taková pecka je průmysl, tam máme 20 % emisí skleníkových plynů.
Průmysl 20 % emisí skleníkových plynů. 
{% include transcript-person.html id="holik" %} Zbytek, nějakých 17 % tvoří hlavně spalování v domácnostech, odpadové hospodářství a pak nějaký další menší zdroje.
{% include transcript-person.html id="svobodova" %}
...
{% include transcript-person.html id="holik" %} Co se tu snažíme tak trochu říct, že nás čeká fakt velká transformace, možná rychlejší, než jakou kdy lidstvo doteďka zažilo. A co je potřeba, je opravdu začít jednat hned. 
{% include transcript-time.html time="07:57" %}
{% include transcript-person.html id="svobodova" %}
...
{% include transcript-person.html id="hanzlik" %}
...
{% include transcript-person.html id="holik" %} Jak, když jsem četl tu vaši studii, tak jsem vlastně z toho takový optimistický pocit, že ten váš výsledek je, že to jde, že je to možné. 
{% include transcript-person.html id="hanzlik" %}
Myslím si, že to je možné. Na druhou stranu je to v podstatě kompletní změna toho, jak ta země funguje, jakým způsobem používáme energie, co konzumujeme, jak konzumujeme, takže na papíře nám to vychází, ale v realitě to bude extrémně složitá cesta, bude to určitě minimálně srovnatelné s tou cestou těch posledních 30 let, kdy česká ekonomika se dostala z centrálně plánované k té jsou současné převážně tržní, tak velká změna nejspíš ještě větší to bude.
Tak velká změna nejspíš ještě větší to bude.
{% include transcript-person.html id="holik" %} Myslíte, že byste mohl zkusit nastínit, co u nás bude jinak, když se ta změna povede? 
{% include transcript-time.html time="09:30" %}
{% include transcript-person.html id="hanzlik" %}
Jsou určitě věci, který budou viditelný na první pohled, jsou věci, který budou neviditelný a budou daleko víc strukturální. Určitě doufám, že bude čistší prostředí, když se projdete venku, tak ten vzduch bude čistší a celá ta věc bude těžší, což hodně souvisí se změnou dopravy, předpokládáme u osobních aut přechod ke kompletní elektromobilitě, takže to bude určitě ve městech, to bude mít velký význam, na vesnicích neuvidíte kouř z komínů, ani když bude únorový večer, tak tam neuvidíte mraky kouře, bude se tam dobře dýchat. To budou takový externí změny, které budou viditelný na první pohled. Zároveň si myslím, že pro spoustu lidí to bude znamenat změnu v tom, co dělají a tím se živí určitě se bude měnit struktura průmyslu, bude se měnit to, na čem lidi pracuju.
{% include transcript-person.html id="hanzlik" %}
...
{% include transcript-person.html id="holik" %} Takže vy si myslíte, že jenom skrze tu změnu ve spotřebitelském chování se vlastně v těch regálech začnou objevovat jiné věci a tím se celý řetězce změní? 
{% include transcript-person.html id="hanzlik" %}
Jo, já jsem přesvědčen.
{% include transcript-person.html id="holik" %} Skrze změnu ve spotřebitelském chování.
{% include transcript-person.html id="hanzlik" %}
Jo, já jsem přesvědčen. 
{% include transcript-person.html id="svobodova" %}
...
{% include transcript-person.html id="holik" %} Jak se stalo, proč vlastně teď, protože vy říkáte, diskuze se hodně posunula za poslední 2 roky, a přitom ta věda ohledně změny klimatu tady už je dlouho. Tak, co se změnilo? 
{% include transcript-person.html id="hanzlik" %}
...
{% include transcript-person.html id="holik" %} Takže dalo by se říct, že ten impuls je legislativní, tím, že tu máme velkou mezinárodní dohodu, tak to je to, co má vliv na finanční trhy, na chování těchhle těch věcí?
{% include transcript-person.html id="hanzlik" %}
...
{% include transcript-time.html time="15:13" %}
{% include transcript-person.html id="svobodova" %}
...
{% include transcript-person.html id="holik" %} Co znamená dekarbonizace v oblasti budov a vytápění?
{% include transcript-person.html id="hanzlik" %}
...
{% include transcript-time.html time="17:04" %}
{% include transcript-person.html id="svobodova" %}
...
{% include transcript-time.html time="17:48" %}
{% include transcript-person.html id="holik" %} Co znamená v našem kontextu dekarbonizace dopravy.
{% include transcript-person.html id="hanzlik" %}
...
{% include transcript-time.html time="18:06" %}
{% include transcript-person.html id="holik" %} Já vždycky když slyším dekarbonizace průmyslu, tak slyším jenom průmysl bude asi těžké dekarbonizovat. Co vlastně znamená dekarbonizovat průmyslu u nás. 
{% include transcript-person.html id="hanzlik" %}
...
{% include transcript-time.html time="19:04" %}
{% include transcript-person.html id="svobodova" %}
...
{% include transcript-person.html id="holik" %} Když si to vztáhnu na jednu domácnost, tak tzn. nemůžu si dovolit elektroauto, takže mám spalovací motor z toho platím daň. Tím pádem ještě méně peněz zase si nemůže dovolit kupovat ty dekarbonizované technologie a tím se vlastně dostáváme téhle spirály a já čím dál víc ztrácím. 
{% include transcript-person.html id="hanzlik" %}
...
{% include transcript-person.html id="holik" %} Vypnu velkou uhelnou elektrárnu, například.
{% include transcript-person.html id="hanzlik" %}
...
{% include transcript-person.html id="holik" %} Vlastně udělat všechny to stejné a zároveň se o tom musí rozhodnut každý sám. 
{% include transcript-person.html id="hanzlik" %}
1000000×.
{% include transcript-person.html id="holik" %} A to se znovu obloukem dostáváme k tomu, že je potřeba vymyslet chytrý finanční motivace. Jednak proto, aby si lidi mohli dovolit a jednak pro to, aby to opravdu udělali.
{% include transcript-person.html id="hanzlik" %}
A aby jim to přišlo fér.
{% include transcript-person.html id="holik" %} Aby si lidi mohli dovolit a jednak pro to, aby to opravdu udělali..
{% include transcript-person.html id="hanzlik" %}
A aby jim to přišlo fér.
{% include transcript-person.html id="svobodova" %}
Ale na co si musíme dát pozor, je financování celé té věci, musíme předejít nerovnostem ve společnosti, aby se nám tady pak nestalo za 30 let tu bude bublina chudých lidí, kteří si prostě dekarbonizaci nemohli dovolit, někdy se tomu říká klimatická chudoba.
Klimatická chudoba. 
{% include transcript-person.html id="holik" %} Viktor Hanzlík nám udělat celkový přehled, jak může přechod ke klimatické neutralitě vypadat. Dejte si čas na vstřebání všech informací a klidně si část epizody pusťte znovu. Přece jen tu mluvíme o docela složitý věci. V další části této epizody se dozvíte, jak konkrétně plánuje přechod ke klimatické neutralitě jedna velká firma, jejíž výrobky určitě máte všichni doma. Vzpomeňme si před tím, že klimatická neutralita znamená, že to ovzduší vypouštíme jen takové množství skleníkových plynů, jaké jsme schopni zachytávat. Díky tomu zastavíme globální růst teploty, zmírníme tak změny klimatu. Pojďme si představit našeho dalšího hosta.
{% include transcript-time.html time="24:23" %}
{% include transcript-person.html id="gerslova" %}
Mé jméno Barbora Geršlová a v IKEA Česká republika, Maďarsko a Slovensko jsem na pozici country sustainability manažera.
{% include transcript-person.html id="holik" %} Jaké jsou vaše plány pro přechod na klimaticky neutrální byznys?
{% include transcript-person.html id="gerslova" %}
...
{% include transcript-time.html time="28:51" %}
{% include transcript-person.html id="gerslova" %}
...
{% include transcript-person.html id="holik" %} A co tím myslíš, když říkáš slovo scénáře. 
{% include transcript-person.html id="svobodova" %}
...
{% include transcript-person.html id="holik" %} My jsme vlastně mluvili o jednom takovým konkrétním scénáři od firmy McKinsey. Jaké další scénáře vlastně máme?
{% include transcript-time.html time="33:16" %}
...
{% include transcript-person.html id="holik" %} No tak já ho poprosím, ať se představí sám stejně jako všichni ostatní.
{% include transcript-person.html id="jungwirth" %}
...
{% include transcript-person.html id="holik" %} Takže když vlastně pracuješ se scénářování, když modeluješ nějaký možný budoucnosti, tak jedna část, kterou počítáš, jsou nějaký technologický změny a vývoj a druhá část je chování lidí, spotřebitelské chování.
{% include transcript-time.html time="35:22" %}
{% include transcript-person.html id="jungwirth" %}	
...
{% include transcript-person.html id="holik" %} Máš nějaký ty scénáře v hlavě teďka, nějakých, se kterými jsi třeba pracoval, který bys mohl uvést jako příklady?
{% include transcript-person.html id="jungwirth" %}
...
{% include transcript-time.html time="37:31" %}
{% include transcript-person.html id="jungwirth" %}
...
{% include transcript-person.html id="holik" %} To, mi co z toho vyplývá, je že říkáš, že ta cesta je vlastně v propojení těch dvou přístupů, jednak té cesty legislativní a jednak té cesty spotřebitelského chování, chování lidí. 
{% include transcript-person.html id="jungwirth" %}
...
{% include transcript-time.html time="39:42" %}
{% include transcript-person.html id="svobodova" %}
Chceme, aby se lidé v tématu změny klimatu lépe orientovali.
{% include transcript-person.html id="holik" %} Aby věděli o řešeních, která máme k dispozici a můžeme je použít.
{% include transcript-person.html id="svobodova" %}
Chcete se na tom taky podílet?
{% include transcript-person.html id="holik" %} Podpořte nás, prosím, finančně. Tvořit podcast můžeme i díky vašim darům. 
{% include transcript-person.html id="svobodova" %}
Darovat můžete na našem webu 2050podcast.cz. 
{% include transcript-person.html id="holik" %} Co jsou vlastně ty klíčový proměnný, který měříš, který sleduješ, na který se díváš a říkáš si, hele na základě toho, jak tahle věc se vyvine, jak se změní budoucnost? 
{% include transcript-time.html time="40:14" %}
{% include transcript-person.html id="jungwirth" %}
...
{% include transcript-person.html id="holik" %} Jak si to mám představit, teďka mluvíme o nějakém konceptu nerůstu a podobných myšlenkách, co to vlastně znamená pro mě jako pro člověka, pro byznys, pro Česko? 
{% include transcript-person.html id="jungwirth" %}
...
{% include transcript-time.html time="44:00" %}
{% include transcript-person.html id="holik" %} Já jsem se před chvílí ptal na to, jaké jsou klíčový proměnný na cestě k dekarbonizaci, co jsou ty věci, který naopak nevíme.
{% include transcript-person.html id="jungwirth" %}
...
{% include transcript-time.html time="47:03" %}
{% include transcript-person.html id="holik" %} Možná když jste poslouchali tuhle tu epizodu, tak si říkáte, jo, já bych tomu chtěl nějak přispět, čím můžete přispět zrovna vy, tomuhle tématu se bude podrobně věnovat v poslední epizodě první série, ale dáme vám už dneska jeden příklad všechny. V České republice je největší problém výroba elektřiny z uhlí, no to co můžete udělat je začít doma odebírat energii z obnovitelných zdrojů.
{% include transcript-person.html id="svobodova" %}
Jo, ale jak na to, jde to vůbec? 
{% include transcript-person.html id="holik" %} Podrobněji se na to podíváme jiné epizodě, ale tady máš aspoň krátký tip od Heleny Továrkové, ředitelky brněnské environmentální nadace Veronica.
{% include transcript-person.html id="tovarkova" %}
...
{% include transcript-person.html id="holik" %} No, jak je vidět, tak některý z těch věcí, který máme před sebou a čekají nás, tak už víme, jak udělat, a dokonce už se dějí jako třeba ten přechod od uhlí.
{% include transcript-person.html id="svobodova" %}
Zároveň je tady řada věcí, které nevíme, jak udělat nebo už víme, že budou náročnější, například u výroby cementu.
{% include transcript-person.html id="holik" %} Je velmi zajímavý se zamýšlet nad tím, jaké ingredience jsou vlastně potřeba, aby se celá tahle změna celá transformace mohlo stát. Technologie vlastně větší části máme v tom není ten hlavní problém. Finanční zdroje budou, když bude jasný, že hele tímhle směrem jako lidstvo nebo společnost jdeme.
{% include transcript-person.html id="svobodova" %}
