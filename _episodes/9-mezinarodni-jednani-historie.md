...
<div class="transcript" markdown="1">
...
{% include transcript-time.html time="02:05" %}
{% include transcript-person.html id="zamyslicky" %}
...
{% include transcript-person.html id="sucha" %}
...
{% include transcript-person.html id="archer" %}
...
{% include transcript-person.html id="mullerova" %}
...
{% include transcript-time.html time="04:27" %}
{% include transcript-person.html id="svobodova" %}
...
{% include transcript-person.html id="svobodova" %}
Pro tyhle potřeby jsme připravili i grafiku, kterou najdete na webu v bonusových materiálech. My si ji teď společně projdeme a jestli máte i vy možnost, klidně se na ni během poslechu tohoto podcastu můžete společně s námi dívat. Jmenuje se Mezinárodní klimatické dohody.
Pro tyhle potřeby jsme připravili i grafiku, kterou najdete na webu v bonusových materiálech. My si ji teď společně projdeme a jestli máte i vy možnost, klidně se na ni během poslechu tohoto podcastu můžete společně s námi dívat.
...
{% include transcript-time.html time="06:40" %}
{% include transcript-person.html id="broza" %}
...
{% include transcript-time.html time="08:28" %}
{% include transcript-person.html id="mullerova" %}
...
{% include transcript-time.html time="09:20" %}
{% include transcript-person.html id="svobodova" %}
...
{% include transcript-time.html time="11:26" %}
{% include transcript-person.html id="brezovska" %}
...
{% include transcript-time.html time="13:26" %}
{% include transcript-person.html id="svobodova" %}
...
{% include transcript-time.html time="14:30" %}
{% include transcript-person.html id="brezovska" %}
...
{% include transcript-time.html time="16:03" %}
{% include transcript-person.html id="holik" %}
