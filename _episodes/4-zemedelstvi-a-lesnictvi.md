...
Rozhovor s Radkem Pokorným byl natočen v rámci projektu [Science Slam MUNI](https://scienceslam.muni.cz/). Za jeho poskytnutí děkujeme Mendelově univerzitě v Brně a Masarykově univerzitě.
...
{% include 2050/transcript-time.html time="01:23" %}
{% include 2050/transcript-person.html id="holik" %}
...
{% include 2050/transcript-person.html id="kozminova" %}
...
{% include 2050/transcript-time.html time="04:33" %}
{% include 2050/transcript-person.html id="holik" %}
...
{% include 2050/transcript-person.html id="pokorny" %}
...
{% include 2050/transcript-person.html id="kotecky" %}
...
{% include 2050/transcript-time.html time="08:33" %}
{% include 2050/transcript-person.html id="holik" %}
...
{% include 2050/transcript-time.html time="12:14" %}
{% include 2050/transcript-person.html id="svobodova" %}
...
{% include 2050/transcript-time.html time="15:59" %}
{% include 2050/transcript-person.html id="holik" %}
...
{% include 2050/transcript-time.html time="20:42" %}
{% include 2050/transcript-person.html id="holik" %}
...
{% include 2050/transcript-time.html time="26:02" %}
{% include 2050/transcript-person.html id="kotecky" %}
...
{% include 2050/transcript-time.html time="31:16" %}
{% include 2050/transcript-person.html id="svobodova" %}
