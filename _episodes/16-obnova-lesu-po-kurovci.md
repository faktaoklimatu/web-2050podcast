...
spotify:    "1Vvmcqg1XWgzlE6s87uhyV"
guests: [ sasek ]
tags:       [ krajina ]
transcript: true
---
...
{% include 2050/transcript-time.html time="00:01" %}
{% include 2050/transcript-person.html id="sasek" %}
...
{% include 2050/transcript-time.html time="00:40" %}
...
{% include 2050/transcript-time.html time="02:36" %}
{% include 2050/transcript-person.html id="lnenicka" %}
To je teda plocha.
...
{% include 2050/transcript-time.html time="03:30" %}
{% include 2050/transcript-person.html id="holik" %}
...
{% include 2050/transcript-time.html time="11:38" %}
...
{% include 2050/transcript-time.html time="17:00" %}
{% include 2050/transcript-person.html id="holik" %}
...
{% include 2050/transcript-person.html id="holik" %}
Zpátky k našemu procesu obnovy lesa. Krok č. 2: zabuření.
Zaboření znamená, že vám mýtina, teďka už plná malých stromků, zaroste trávou. Tu musíte pravidelně ožínat, tzn. prostě kosit, jinak vám mladé stromky zadusí.

Následně máte pár let klid, dokud nepřijde čas na krok č. 3: na první prořezávky.
Na začátku totiž zasadíme stromků hodně, ale postupně až 9 z 10 mladých stromků odstraníme.
...
{% include 2050/transcript-time.html time="25:11" %}
{% include 2050/transcript-person.html id="holik" %}
...
{% include 2050/transcript-time.html time="28:45" %}
{% include 2050/transcript-person.html id="holik" %}
...
{% include 2050/transcript-time.html time="36:50" %}
{% include 2050/transcript-person.html id="holik" %}
